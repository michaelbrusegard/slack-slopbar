...
source_app="$project_directory/build/Slack Slopbar.app"
applications_directory="${HOME:?}/Applications"
installed_app="$applications_directory/Slack Slopbar.app"
legacy_app="$applications_directory/Slack Menubar.app"
...
osascript -e 'tell application "Slack Slopbar" to quit' >/dev/null 2>&1 || true
